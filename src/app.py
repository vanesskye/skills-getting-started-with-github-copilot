...
activities = {
    ...
    "Soccer Club": {
        "description": "Team-based soccer training and weekend friendly matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, learn stagecraft, and perform dramatic works",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions through hands-on experiments and research",
